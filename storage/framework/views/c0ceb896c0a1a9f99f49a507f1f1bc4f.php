...
<div class="details_size">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" value="<?php echo e($productSize->id); ?>" name="flexRadioDefault" id="size-<?php echo e($productSize->id); ?>">
...
<div class="details_extra_item">
    ...
    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="<?php echo e($productOption->id); ?>" id="option-<?php echo e($productOption->id); ?>">

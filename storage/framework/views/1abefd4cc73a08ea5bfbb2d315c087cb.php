        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_25">
                    <h4><?php echo @$sectionTitle['why_choose_top_title']; ?></h4>
                    <h2><?php echo @$sectionTitle['why_choose_main_title']; ?></h2>
                    <span>
                        <img src="<?php echo e(asset('frontend/images/heading_shapes.png')); ?>" alt="shapes" class="img-fluid w-100">
                    </span>
                    <p><?php echo @$sectionTitle['why_choose_sub_title']; ?></p>
                </div>
            </div>
        </div>
        <div class="row">
...
<?php /**PATH C:\laragon\www\laravel-10-food-order\resources\views/frontend/home/components/why-choose.blade.php ENDPATH**/ ?>
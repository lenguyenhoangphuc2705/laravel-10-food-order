    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?php echo e(route("home")); ?>">Trang chủ</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <ul class="droap_menu">
                        ...
                        <li><a href="<?php echo e(route("cart.index")); ?>">Xem giỏ hàng</a></li>
...
<?php /**PATH C:\laragon\www\laravel-10-food-order\resources\views/frontend/layouts/menu.blade.php ENDPATH**/ ?>
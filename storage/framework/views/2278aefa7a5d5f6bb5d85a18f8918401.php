<?php $__env->startSection('content'); ?>
    <section class="section">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.delivery-area.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-10-food-order\resources\views/admin/delivery-area/create.blade.php ENDPATH**/ ?>